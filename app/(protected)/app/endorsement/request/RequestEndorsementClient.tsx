...
export function RequestEndorsementClient({
  ...
  return (
    <div className="min-h-screen bg-[var(--color-surface)] px-4 pt-8 pb-24">
      ...
      <div className="bg-[var(--color-surface)] rounded-2xl p-4 mb-6">
        ...
        <div className="flex gap-2">
          <button
            ...
            disabled={!shareLink}
            className="flex-1 flex items-center justify-center gap-2 h-11 rounded-xl bg-[#25D366] text-white text-sm font-medium hover:bg-[#20bd5a] transition-colors disabled:opacity-50"
          >
          ...
          <button
            onClick={copyLink}
            disabled={!shareLink}
            className="flex-1 flex items-center justify-center gap-2 h-11 rounded-xl bg-[var(--color-surface-raised)] text-[var(--color-text-primary)] text-sm font-medium hover:bg-[var(--color-surface-overlay)] transition-colors disabled:opacity-50"
          >
          ...
          <button
            onClick={nativeShare}
            disabled={!shareLink}
            className="h-11 w-11 shrink-0 flex items-center justify-center rounded-xl bg-[var(--color-surface-raised)] text-[var(--color-text-primary)] hover:bg-[var(--color-surface-overlay)] transition-colors disabled:opacity-50"
      ...
      {/* Rate limit */}
      <p className={`text-xs ${remaining === 0 ? 'text-red-400' : 'text-[var(--color-text-tertiary)]'}`}>
