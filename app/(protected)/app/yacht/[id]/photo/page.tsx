  ...
  return (
    <div className="min-h-screen bg-[var(--color-surface)] px-4 pt-8 pb-24">
      ...
      <div
        ...
        className="relative w-full aspect-[16/9] rounded-2xl bg-[var(--color-surface-raised)] overflow-hidden mb-6 cursor-pointer border-2 border-dashed border-[var(--color-border)] hover:border-[var(--ocean-500)] transition-colors"
      >
        {preview ? (
