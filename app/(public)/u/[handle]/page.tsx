...
export default async function PublicProfilePage({ params }: Props) {
  ...
  // Fetch all data in parallel via shared helpers
  const [
  ...
  // Viewer relationship (shared yachts, mutual colleagues, saved status)
  ...
  // dob is REVOKE'd from anon — only fetch via authenticated query to avoid breaking
  // the public profile page for logged-out visitors.
  ...
  // Strip PII server-side — never send raw DOB or hidden contact to client
  const sanitisedUser = {
    ...user,
