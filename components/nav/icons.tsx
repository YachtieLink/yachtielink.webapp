/* ─── Shared nav icons (outline / filled pairs) ──────────────────────────── */
...
export function InsightsIconFilled() {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className="h-full w-full">
...
export function NetworkIconFilled() {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className="h-full w-full">
...
export function MoreIconFilled() {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className="h-full w-full">
