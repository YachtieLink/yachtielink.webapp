        ...
        <div className="flex flex-col gap-3">
          ...
          {!searching && results.length === 0 && query.trim() && (
            <p className="text-xs text-[var(--color-text-secondary)] px-1">
              ...
              <button
                className="text-[var(--ocean-500)] underline"
        ...
        <div className="flex flex-col gap-4">
          ...
          <div>
            ...
            <select
              ...
              className="w-full rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface)] px-4 py-3 text-sm text-[var(--color-text-primary)] focus:outline-none focus:ring-2 focus:ring-[var(--ocean-500)]"
            >
        ...
        <div className="flex flex-col gap-2 mb-4">
          {dupeCandidates.map((c) => (
            ...
            >
              ...
              <p className="text-xs text-[var(--ocean-500)] mt-1 font-medium">Use this yacht →</p>
            </button>
          ))}
        </div>
        <button
