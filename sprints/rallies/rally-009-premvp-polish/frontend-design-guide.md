...
> **Canonical location:** `docs/design-system/patterns/frontend-design-guide.md` — this rally copy is kept for reference but the design-system copy is the source of truth.
