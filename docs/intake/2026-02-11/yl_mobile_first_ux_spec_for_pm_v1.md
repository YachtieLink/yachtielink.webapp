...
Rule:
- Connections do not enable endorsements by themselves.

---

### Screen A3 — Co-workers
List only users who share ≥1 yacht attachment with you.
Row: name, shared yacht label, CTA: Write/Request endorsement (contextual)
...
- Yacht fixed at top
- Suggested co-workers first (shared-yacht list)
